...
const { CarrierPhones, Carrier } = require("../../models");
...
const getOneUserAllPhones = async (req, res) => {
    const { active, deleted } = req.query;
    const { id } = req.params;
    const Active = active
        ? {
...
const getOnePhone = async (req, res) => {
    const { id } = req.params;
    const data = await CarrierPhones.findOne({ where: { id: id } });
    if (data) {
        CarrierPhones.findOne({
            where: {
                id: id,
            },
        })
...
const create = async (req, res) => {
    const { phone, CarrierId } = req.body;
...
const disActive = async (req, res) => {
    const { id } = req.params;
    let data = await CarrierPhones.findOne({ where: { id: id } });
    if (data) {
        CarrierPhones.update(
            {
                active: false,
...
exports.getOneUserAllPhones = getOneUserAllPhones;
